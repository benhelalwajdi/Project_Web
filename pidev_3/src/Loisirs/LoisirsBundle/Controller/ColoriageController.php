...
use Loisirs\LoisirsBundle\Entity\Coloriage;
use Loisirs\LoisirsBundle\Form\ColoriageType;
...
class ColoriageController extends Controller
{
    ...
    public function AfficheColoriageAction(Request $request)
    {
        ...
        return $this->render('LoisirsLoisirsBundle:Coloriage:coloriage.html.twig',$data);
    ...
    public function downloadFileAction($nom){
        $response = new BinaryFileResponse('coloriages/'.$nom);
